...
parser.add_argument('--teacher_type', type=str, default='vgg', help='which model to use for teacher model', choices=['vgg', 'resnet'])
...
parser.add_argument('--temp', default=5, type=int, help='temperature for Kullback Leibler Divergence Loss')
